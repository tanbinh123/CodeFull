...
public class quanlynguoihoc extends javax.swing.JFrame {
    ...
    public boolean checkInsertHocVien() {
        if (txtMaNH.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đủ ma nhan vien");
            txtMaNH.setBackground(Color.red);
            txtMaNH.requestFocus();
            return false;
        }
        if (txtHoTen.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đủ ho ten");
            txtMaNH.setBackground(Color.red);
            txtMaNH.requestFocus();
            return false;
        }
        if (txtDienThoai.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập so dien thoai");
    ...
    private void initComponents() {
        ...
        cboGioiTinh.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
