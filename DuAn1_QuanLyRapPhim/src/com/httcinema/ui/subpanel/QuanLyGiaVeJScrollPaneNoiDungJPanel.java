...
public class QuanLyGiaVeJScrollPaneNoiDungJPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public QuanLyGiaVeJScrollPaneNoiDungJPanel() {
		...
		txtTimKiem.setPlaceholder("Tìm mô tả giá vé...");
		...
		btnThem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				QuanLyGiaVeJScrollPaneNoiDungJPanelThongTinChiTietJDialog.showDialog(ManHinhChinhJFrame.frameManHinhChinh, null, QuanLyGiaVeJScrollPaneNoiDungJPanelThongTinChiTietJDialog.THEM);
			}
		});
...
//				return false;
	...
	private void loadTable() {
        ...
        try {
			...
			List<GiaVe> list = new GiaVeDAO().selectByKeyword(keyword);
            for (GiaVe giaVe : list) {
                Object[] row = {
            		giaVe.getMaGiaVe(),
            		new DecimalFormat("###,###,###,###,###,###").format(giaVe.getGiaVe()) + " VND",
            		giaVe.getMoTa(),
	...
	Action delete = new AbstractAction() {
		public void actionPerformed(ActionEvent e) {
			...
			// hard code: Không cho phép xóa các hàng cố định, bốn dữ liệu mặc định không được xóa
			...
			if (DialogHelper.confirm(ManHinhChinhJFrame.frameManHinhChinh, "Bạn thực sự muốn xóa?")) {
				try {
					new GiaVeDAO().delete(primaryKey);
	...
	Action edit = new AbstractAction() {
		public void actionPerformed(ActionEvent e) {
			...
			GiaVe giaVe = new GiaVeDAO().findById(primaryKey + "");
			
			QuanLyGiaVeJScrollPaneNoiDungJPanelThongTinChiTietJDialog.showDialog(ManHinhChinhJFrame.frameManHinhChinh, giaVe, QuanLyGiaVeJScrollPaneNoiDungJPanelThongTinChiTietJDialog.CAP_NHAT);
		}
	};
