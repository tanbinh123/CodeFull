...
public class CustomPasswordField extends JPasswordField {
    ...
    protected PlainDocument customPasswordFieldFilter;
    
    public CustomPasswordField(int maxLen) {
		setMaxLength(maxLen);
		setSelectionColor(Theme.green);
		customPasswordFieldFilter = new CustomPasswordFieldFilter();
		super.setDocument(customPasswordFieldFilter);
	}
    ...
    public void setPlaceholder(final String text) {
        ...
        this.getDocument().addDocumentListener(new DocumentListener() {
			...
			public void warn() {
                if (new String(getPassword()).trim().length() != 0) {
    ...
    public char[] getPassword() {
    	char[] arr = super.getPassword();
    	
    	if (new String(arr).equals(placeholder)) {
    		return new char[0];
    	}
    	else {
    		return arr;
    ...
    class CustomPasswordFieldFilter extends PlainDocument {
		private static final long serialVersionUID = 1L;

		public CustomPasswordFieldFilter() {
			super();
		}
