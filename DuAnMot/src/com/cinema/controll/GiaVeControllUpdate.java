 ...
 * @author thanh
 */
public class GiaVeControllUpdate extends javax.swing.JDialog implements IPopupDialog{
    ...
    public GiaVeControllUpdate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.jpanel = jpanel;
    ...
    public GiaVeControllUpdate(java.awt.Frame parent, boolean modal,JTable table, QuanLyGiaVe jpanel) {
        super(parent, modal);
        initComponents();
        this.jpanel = jpanel;
        this.table = table;
    ...
    GiaVe getModel(){
        GiaVe gv = new GiaVe();
        gv.setMaGiaVe(Integer.valueOf(lblMa.getText()));
    ...
    private void initComponents() {
        ...
        txtGiaVe.setFont(new java.awt.Font("Tahoma", 0, 17)); // NOI18N

        txpMoTa.setFont(new java.awt.Font("Tahoma", 0, 17)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(btnKhong, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaVeControllUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GiaVeControllUpdate dialog = new GiaVeControllUpdate(new javax.swing.JFrame(), true);
    ...
    public void actionAfterClick(ActionEvent e) {
        ...
        txtGiaVe.setText(String.valueOf(gv.getGiaVe()));
        txpMoTa.setText(gv.getMoTa());
