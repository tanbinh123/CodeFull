 ...
 * @author thanh
 */
public class IfNullPassWord extends javax.swing.JDialog {

    /**
     * Creates new form IfNullDialog
     */
    public IfNullPassWord(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("BẠN CHƯA NHẬP MẬT KHẨU!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IfNullPassWord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IfNullPassWord dialog = new IfNullPassWord(new javax.swing.JFrame(), true);
