 ...
 * @author thanh
 */
public class GiaVeDialog extends javax.swing.JDialog {

    /**
     * Creates new form PhimDialog
     */
    public GiaVeDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("GIÁ VÉ NÀY ĐÃ ĐƯỢC SỬ DỤNG!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaVeDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GiaVeDialog dialog = new GiaVeDialog(new javax.swing.JFrame(), true);
