 ...
 * @author thanh
 */
public class NhapLieuDialog extends javax.swing.JDialog {

    /**
     * Creates new form ChonLichChieu
     */
    public NhapLieuDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("VUI LÒNG NHẬP LIỆU ĐẦY ĐỦ!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhapLieuDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NhapLieuDialog dialog = new NhapLieuDialog(new javax.swing.JFrame(), true);
