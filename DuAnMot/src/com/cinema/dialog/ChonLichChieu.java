 ...
 * @author thanh
 */
public class ChonLichChieu extends javax.swing.JDialog {

    /**
     * Creates new form ChonLichChieu
     */
    public ChonLichChieu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("BẠN CHƯA CHỌN LỊCH CHIẾU!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChonLichChieu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChonLichChieu dialog = new ChonLichChieu(new javax.swing.JFrame(), true);
