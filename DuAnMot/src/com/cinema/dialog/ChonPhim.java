 ...
 * @author thanh
 */
public class ChonPhim extends javax.swing.JDialog {

    /**
     * Creates new form ChonLichChieu
     */
    public ChonPhim(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("BẠN CHƯA CHỌN PHIM!");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChonPhim dialog = new ChonPhim(new javax.swing.JFrame(), true);
