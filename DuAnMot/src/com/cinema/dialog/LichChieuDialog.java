 ...
 * @author thanh
 */
public class LichChieuDialog extends javax.swing.JDialog {

    /**
     * Creates new form PhimDialog
     */
    public LichChieuDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("LỊCH CHIẾU NÀY ĐÃ HIỆN HÀNH!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LichChieuDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LichChieuDialog dialog = new LichChieuDialog(new javax.swing.JFrame(), true);
