...
public class Student {
    ...
    public Student(String maSinhVien, String tenSinhVien, String Email, String SDT,boolean gioiTinh, String diaChi,String hinh,float tiengAnh, float tinHoc, float giaoDucTC){
