    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
        <div class="page-wrapper">
            ...
            <div class="page-container">
                <!-- start sidebar menu -->
                <%@include file="blocks/sidebarUser.jsp" %>
                <!-- end sidebar menu -->
                <!-- start page content -->
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item" href="">CÁC LOẠI MẶT HÀNG</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                            ...
                                            <table id="example1" class="display" style="width:100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <form action="ProductController" method="get">
                                                        <td>${product.id}<input type="hidden" name="id" value="${product.id}"></td>
                                                        <td>${product.name}<input type="hidden" name="ten" value="${product.name}"></td>
                                                        <td>${product.price}<input type="hidden" name="gia" value="${product.price}"></td>
                                                        <td>${product.note}<input type="hidden" name="note" value="${product.note}"></td>
                                                        <td><img src="./Image/${product.image}" width="180" height="180"><input type="hidden" name="image" value="${product.image}"></td>
                                                        <td>${product.idcategory_id == 1 ? "ĐIỆN THOẠI" : "LAPTOP" }<input type="hidden" name="idcate" value="${product.idcategory_id}"></td>
                                                        <td>
                                                            <button class="btn btn-primary" name="_action" type="submit" value="${RequestAction.BUY}">BUY</button>
                                                        </td>
                                                    </form>
                                                    </tr>
                                                </c:forEach>
