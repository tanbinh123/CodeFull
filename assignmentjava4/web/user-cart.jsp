                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item" href="">Quản Lý Thành Viên</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    ...
                                    <div class="card-body ">
                                        <div class="table-scrollable">
                                            ...
                                            <table id="example1" class="display" style="width:100%;">
                                                ...
                                                <tbody>
                                                    <c:forEach var="product" items="${productDao.filltocart()}">
                                                        <tr>
                                                    <form action="ProductController" method="get">
                                                        ...
                                                        <td>${product.idcategory_id == 1 ? "ĐIỆN THOẠI" : "LAPTOP" }<input type="hidden" name="iddelete" value="${product.idcategory_id}"></td>
                                                        <td>
                                                            <button class="btn btn-primary" name="_action" type="submit" value="${RequestAction.DELETECART}">DELETE</button>
                                                        </td>
                                                    </form>
                                                    </tr>
                                                </c:forEach>
