                                    ...
                                    <div class="card-body ">
                                        <div class="table-scrollable">
                                            <table id="mainTable" class="table table-striped">
                                                ...
                                                <tbody>
                                                    <c:forEach var="user" items="${userDao.fillToTable()}">
                                                        <tr>
                                                    <form action="UserController" method="POST">
                                                        <td>${user.id} </td><input type="hidden" name="id" value="${user.id}" id="index"/>
                                                        <td><input class="form-control" type="text" name="username" value="${user.username}" id="index"/></td>
                                                        <input type="hidden" name="password" name="password" value="${user.password}" id="index">
                                                        <td><input class="form-control" type="text" name="fullname" value="${user.fullname}" id="index"/></td>
                                                        <td><input class="form-control" type="text" name="phone" value="${user.phone}" id="index"/></td>
                                                        <td><input class="form-control" type="text" name="email" value="${user.email}" id="index"/></td>
                                                        <td>${user.role == 1 ? "USER" : "CUSTOMER"} <input type="hidden" name="role" value="${user.role}" id="index"/></td>
                                                        <td>
